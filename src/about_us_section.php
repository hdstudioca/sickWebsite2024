...
<section id="aboutUsSection" class="py-3 py-md-5 py-xl-8 container">
	...
	<div class="container mt-5">
		<div class="row gy-3 gy-md-4 gy-lg-0">
			<div class="col-12 col-lg-6">
				<div id="animateDiv" class="card bg-light p-3 m-0">
					<div class="row gy-3 gy-md-0 align-items-md-center">
						<div class="col-md-5">
							<img src="../res/pexels-djordje-petrovic-590080-2102416.jpg" class="img-fluid rounded-start" alt="man-in-black-shirt-sits-behind-desk-with-computers">
						</div>
						<div class="col-md-7">
			...
			<div class="col-12 col-lg-6">
				<div id="animateDiv2" class="card bg-light p-3 m-0">
					<div class="row gy-3 gy-md-0 align-items-md-center">
						<div class="col-md-5">
							<img src="../res/pexels-juanico-2777719.jpg" class="img-fluid rounded-start" alt="...">
						</div>
						<div class="col-md-7">
							<div class="card-body p-0">
			...
			<p class="col-lg-10 fs-4 fw-bold lh-lg">
				Hours of operation: 8am to 6pm PST
			</p>
		</div>
	</div>
</div>
