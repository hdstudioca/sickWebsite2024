...
<div id="contact_us_section">
	<div class="row align-items-center g-lg-5 py-5">
		<div class="col-lg-7 text-center text-lg-start">
			...
			<p class="col-lg-10 fs-4">Join me on thrilling adventures in the virtual battlegrounds of League
				of
				Legends! Withness epic battles, masterful strategies, and exhilerating victories as I dive
				into
				the world of intense competition and teamwork. </p>
		</div>
